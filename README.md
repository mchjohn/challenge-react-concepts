...
<img src="https://github.com/mchjohn/challenge-react-concepts/blob/main/img/todo-app.gif" data-canonical-src="https://github.com/mchjohn/challenge-react-concepts/blob/main/img/todo-app.gif" width="968" height="520" />

## Sobre esse projeto

Este é o primeiro desafio da trilha de reactjs proposto pela RocketSeat

***Ele é obrigatório aos alunos que estão participando do bootcamp Ignite***

## Qual é o objetivo

A partir de uma template, completar a criação de uma aplicação ***TO.DO***, respeitando todos os testes que serão executados via jest.
...
```
$ git clone https://github.com/mchjohn/challenge-react-concepts

$ cd challenge-react-concepts
```
